...
export default function PricingPage() {
  return (
    <div className="p-8 max-w-4xl mx-auto">
            ...
            <ul className="space-y-2 mb-5 flex-1">
              {["Image generation", "Video generation", "HD downloads", "Never expires", "All AI models"].map((f) => (
                <li key={f} className="flex items-center gap-2 text-xs text-white/50">
                  <Check className="w-3.5 h-3.5 text-[#1a73e8] flex-shrink-0" />
                  {f}
                </li>
              ))}
            </ul>
      ...
      {/* Credit usage table */}
      <div className="border border-white/8 rounded-2xl bg-[#0d0d0d] overflow-hidden">
      ...
      {/* Free credits note */}
      <div className="mt-6 border border-[#1a73e8]/20 bg-[#1a73e8]/5 rounded-2xl px-5 py-4 flex items-center gap-3">
